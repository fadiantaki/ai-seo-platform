    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <nav className="flex items-center justify-between px-8 py-5 border-b border-white/10">
        ...
        <div className="flex items-center gap-4">
          <a href="https://instagram.com/aivisible_eg" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-pink-400 transition-colors" title="@aivisible_eg on Instagram">
      ...
      <div className="max-w-5xl mx-auto px-8 py-12">
        <div className="mb-8">
          ...
          <p className="text-slate-500 text-sm mt-3">
            ...
            {' '}or DM us on{' '}
            <a href="https://instagram.com/aivisible_eg" target="_blank" rel="noopener noreferrer" className="text-pink-400 hover:text-pink-300 transition-colors">@aivisible_eg</a>
